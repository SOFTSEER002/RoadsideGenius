...
public class UnassignAdapter extends RecyclerView.Adapter<UnassignAdapter.RecyclerHolder> {
    Context context;

    public UnassignAdapter(Context context, List<Job> jobs) {
    ...
    @NonNull
    @Override
    public UnassignAdapter.RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.unassign_recyclerview, parent, false);
        return new RecyclerHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UnassignAdapter.RecyclerHolder holder, int position) {
