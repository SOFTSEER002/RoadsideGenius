...
public class UploadDriverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_upload_driver, container, false);
...
//                        .setSelectedFiles(filePaths) //optional
    ...
    void uploadScaForm() {
        ...
        RequestBody token = RequestBody.create(okhttp3.MultipartBody.FORM, sharedPreferenceMethod.getJWTToken());
