...
//        if()
        ...
        apiService.paymentList(sharedPreferenceMethod.getJWTToken(), startDate, endDate, "",
...
//                    paymentTotalTxt.setText("$" + paymentAmount);
    ...
    void getWalletData() {
//        customProgressBar.showProgress();
        apiService.driverWalletData(sharedPreferenceMethod.getJWTToken()).enqueue(new Callback<WalletDataModel>() {
            @Override
...
//                        pendingWithdrawlRequest = response.body().getResponse().getPendingWithdrawlRequest();
                        ...
                        int pending = Integer.parseInt(response.body().getResponse().getPendingWithdrawlRequest().getAmount());
                        amount = wallet - pending;
                        walletAmountTxt.setText("$" + amount);
